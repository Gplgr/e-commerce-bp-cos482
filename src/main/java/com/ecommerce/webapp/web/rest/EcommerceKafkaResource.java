...
@RestController
@RequestMapping("/api/ecommerce-kafka")
public class EcommerceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EcommerceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public EcommerceKafkaResource(KafkaProperties kafkaProperties) {
