...
class ProdutoResourceIT {
    ...
    public static Produto createEntity(EntityManager em) {
        Produto produto = new Produto().name(DEFAULT_NAME).price(DEFAULT_PRICE);
        return produto;
    }
    ...
    public static Produto createUpdatedEntity(EntityManager em) {
        Produto produto = new Produto().name(UPDATED_NAME).price(UPDATED_PRICE);
        return produto;
    }
    ...
    void putNewProduto() throws Exception {
        ...
        updatedProduto.name(UPDATED_NAME).price(UPDATED_PRICE);
    ...
    void partialUpdateProdutoWithPatch() throws Exception {
        ...
        partialUpdatedProduto.price(UPDATED_PRICE);
    ...
    void fullUpdateProdutoWithPatch() throws Exception {
        ...
        partialUpdatedProduto.name(UPDATED_NAME).price(UPDATED_PRICE);
